...
<Link href="https://fonts.googleapis.com/css2?family=Lato&family=Roboto&display=swap" rel="stylesheet"></Link>
    ...
    <header className = "flex flex-row md:flex-col mt-0 bg-whitep-4 text-white text-[150%] ">
        <Link href = "/" className = "text-black ml-[2%] font-nunito hover:text-slate-400 transition-all duration-[500ms] p-3 ">About Us </Link>
        ...
        <Link href = "/tournaments" className = "text-black ml-[5%] font-nunito hover:text-slate-400 transition-all duration-[500ms] p-3 underline "><b>Classes & Tournaments</b></Link>
 ...
 <div className = "px-10">
    ...
    <div className = "w-full align-center text-center justify-center text-[300%] text-white md:text-black md:bg-gradient-to-r from-red-500 via-pink-500 to-indigo-500 font-nunito bg-black "><strong>About Us</strong></div>
