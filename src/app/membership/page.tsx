  ...
  return (
    <>
      ...
      <body className="relative">
        <div className="flex flex-row md:flex-col mt-0 bg-white p-4 text-white text-[150%] ">
          <Link
            href="/"
            className="text-black ml-[2%] font-nunito hover:text-slate-400 transition-all duration-[500ms] md:text-center p-3 "
          >
            About Us
          </Link>
          <Link
            href="/membership"
            className="text-black ml-[5%] md:ml-[2%] font-nunito hover:text-slate-400 transition-all duration-[500ms] p-3 md:text-center underline"
          >
            <b>Membership</b>
          </Link>
          <Link
            href="/tournaments"
            className="text-black ml-[5%] md:ml-[2%] font-nunito hover:text-slate-400 transition-all duration-[500ms] p-3 md:text-center"
          >
            Classes & Tournaments
          </Link>
        </div>
        ...
        <div className="w-full align-center text-center justify-center text-[300%] text-white font-nunito bg-black">
          ...
          <div className="flex flex-row">
            <div className="rounded-md bg-gradient-to-r from-blue-500 via-purple-500 to-green-500 p-1 w-[25%] overflow-auto mt-[10%] ml-[3%] h-fit">
              <div className="flex bg-black overflow-auto text-center h-full">
                <article className="text-[175%] font-nunito bg-gradient-to-r from-blue-500 via-purple-500 to-green-500 inline-block text-transparent bg-clip-text p-[5%] block w-[100%] overflow-auto">
