...
export default function Home() {
  const greeting =
    "align-middle text-[450%] text-white  font-nunito text-center items-center justify-center";
  return (
    <>
      <link
      ...
      <body className="relative">
        <header className="flex flex-row md:flex-col mt-0 bg-white p-4 text-white text-[150%] ">
          <Link
            href="/"
            className="text-black ml-[2%] font-nunito hover:text-slate-400 transition-all duration-[500ms] p-3 underline"
          >
            <b>About Us </b>
          </Link>
          <Link
        ...
        <div className="w-full align-center text-center p-3 justify-center text-[300%] text-white md:text-black md:bg-gradient-to-r from-red-500 via-pink-500 to-indigo-500 font-nunito bg-black ">
        ...
        <div className="h-screen bg-black bg-cover md:flex-column">
          <div className="flex flex-row">
              ...
              <div className="flex bg-black overflow-auto text-center h-full">
                <article className="text-[175%] font-nunito bg-gradient-to-r from-red-500 via-pink-500 to-indigo-500 inline-block text-transparent bg-clip-text p-[5%] block w-[100%] overflow-auto">
                  ...
                  <p className="align-center text-center justify-center text-[75%] text-white mt-[3%]">
                    ...
                    to the next level! By getting tutoring from 1600 USCF rated
            ...
            <div className=" rounded-md bg-gradient-to-r from-red-500 via-pink-500 to-indigo-500 p-1 w-[25%] overflow-auto mt-[10%] ml-[10%]">
              <div className="flex bg-black overflow-auto text-center h-full height-">
                <article className="text-[175%] font-nunito bg-gradient-to-r from-red-500 via-pink-500 to-indigo-500 inline-block text-transparent bg-clip-text p-[5%] block w-[100%] overflow-auto">
