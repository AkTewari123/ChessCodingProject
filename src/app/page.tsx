...
export default function Home() {
  return (
    ...
    <header className = "flex flex-row md:flex-col mt-0 bg-whitep-4 text-white text-[150%] ">
        <Link href = "/aboutus" className = "text-black ml-[2%] font-sans hover:text-slate-400 transition-all duration-[500ms] md:text-center p-3">About Us </Link>
        <Link href = "/membership" className = "text-black ml-[5%] md:ml-[2%] font-sans hover:text-slate-400 transition-all duration-[500ms] p-3 md:text-center">Membership</Link>
        <Link href = "/tournaments" className = "text-black ml-[5%] md:ml-[2%] font-sans hover:text-slate-400 transition-all duration-[500ms] p-3 md:text-center">Classes & Tournaments</Link>
      </header>
 ...
 <div className = "px-10">
    ...
    <div className = "w-full align-center text-center justify-center text-[300%] text-white font-sans bg-black"><b>About Us</b></div>
  ...
  <div className="rounded-md bg-gradient-to-r from-red-500 via-pink-500 to-indigo-500 p-1 w-[25%] overflow-auto mt-[10%] ml-[10%] h-fit">
    <div className="flex bg-black overflow-auto text-center h-full">
      <article className="text-[175%] font-sans bg-gradient-to-r from-red-500 via-pink-500 to-indigo-500 inline-block text-transparent bg-clip-text p-[5%] block w-[100%] overflow-auto">
  ...
  <div className="rounded-md bg-gradient-to-r from-pink-300 via-purple-300 to-indigo-400 p-1 w-[25%] overflow-auto mt-[10%] ml-[10%] h-fit">
    <div className="flex bg-black overflow-auto text-center h-full">
      <article className="text-[175%] font-sans bg-gradient-to-r from-pink-300 via-purple-300 to-indigo-400 inline-block text-transparent bg-clip-text p-[5%] block w-[100%] overflow-auto">
        <strong>How Do I Sign up?</strong><p className = "align-center text-center justify-center text-[75%] text-white mt-[3%]">
          By texting 732-772-3931, you can express your interest in your chess club! Remember to cruise through the website to find out more about class dates and times! In addition, you can also sign up for private tutoring with Akshat for the $20 for 30 minutes deal! Have a nice day! We hope to see you in our chess club! 
          </p></article>
    </div>
  </div>
</div>
